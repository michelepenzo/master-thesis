...
def change_control_mode_position_control(control_mode, joint_impedance, cartesian_impedance, desired_force, sine_pattern, limits):
	...
	try:
		control_mode_response = _control_mode(control_mode_request) 
...
if __name__ == '__main__':
	...
	_control_mode = rospy.ServiceProxy('/iiwa/configuration/ConfigureControlMode',srv.ConfigureControlMode)
