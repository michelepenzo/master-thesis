...
\begin{document}
	...
	\begin{abstract}
		...
		\paragraph{}
		Con Industria 4.0 i robot sono sempre più presenti in ambito industriale, dove  è presente una forte necessità di poterli riprogrammare velocemente e in modo semplice. Con il passare del tempo sono state introdotte diverse metodologie per la riprogrammazione dei task che il robot deve compiere. In questo lavoro, sono state confrontate due metodologie per l'insegnamento di task industriali: insegnamento cinestetico e insdescribesegnamento tramite teleoperazione. Inoltre, un gruppo di utenti è stato sottoposto ad un esperimento per trovare la modalità più semplice, intuitiva e comoda per svolgere task di assemblaggio. Il lavoro dimostra come le caratteristiche fisiche e la confidenza con il pad usato per la teleoperazione influiscono sull'insegnamento dei task.
	\end{abstract}
