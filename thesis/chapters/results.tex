...
The questionnaire was divided into two phases as described in section \ref{post-experiment-phase}, the first part has already been presented in \ref{participants}. The second part instead asked mainly three questions:
...
\end{itemize}
% trovare correlazioni tra la stazza e la difficolta per fare kt, oppure età ecc...

\noindent The last part of the questionnaire asks general questions about the two modalities. In this case almost everyone the users agree on the answers.The question can were:
\begin{itemize}
	\item Which of the two modalities was generally easier to perform tasks?
	
	Eight of them answered \kt{}, the others \te{}. % correlezione se sono gamer?
	
	\item Which of the two modalities do you think is more enjoyable?
	
	\ldots
	
	\item Which of the two modalities would you prefer to be able to quickly change the task in industry?
	
	\ldots
	
	\item For high-precision tasks such as task 3 which of the modalities was simpler?
	
	\ldots
	
	\item Do you think you have achieved improvements by repeating the same task?
...
\end{itemize}
To the first question that asked to them which is in general the simplest modality to perform task,
