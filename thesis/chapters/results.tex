...
\noindent For a better understanding of the data presented in tables it's possible to group everything using boxplots. 
% TODO quanti boxplot ?

For the questionnaire, based on user responses was possible to collect the data relative to physical and mental effort by the two groups, always divided by personal characteristics.
