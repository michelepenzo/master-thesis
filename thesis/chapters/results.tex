...
\noindent \\\\
As described in \ref{data-collection} many data were collected during the experiment. One of these were the \texttt{cartesian\_wrench}: it's composed of a vector that represent the force along all the three directions. 
