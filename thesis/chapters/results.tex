...
\begin{itemize}
	...
	\begin{table}[ht]
		...
		\begin{tabular}{l||llllll}
			...
			\hline\hline	
			\textbf{\checkmark}	&$ 80\% $	&$ 50\% $	&$ 100\% $	&$ 90\% $ &$ 90\% $	&$ 70\% $ \\
		\end{tabular}
...
\subsection{Groups}
From the questionnaire questions and answers is possible to create some different groups based on personal physical characteristics or from others characteristics. Many different factors were analyzed to see if there was a correlation between the various characteristics of the users and the results obtained from the experiment. Two main groups have been highlighted and later presented.
