...
\noindent \\\\
As described in \ref{data-collection} many data were collected during the experiment. One of these is the \texttt{cartesian\_wrench}: it's composed of a vector that represent the force along all the three directions. In figure \ref{fig:plot_wrench} is possible to see the differences between the force applied on EE during the experiment. In both the figure on $ y $ axis there's the force applied on Z and along $ x $ axis there is the time for completing the trial. In these figure is represented only one trial of the same user.

\begin{figure}[H]
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{wrench_tt.png}
		\caption{Wrench on Z in \te{}}
		\label{fig:wrench_tt}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{wrench_kt.png}
		\caption{Wrench on Z in \kt{}}
		\label{fig:wrenck_kt}
	\end{subfigure}
...
%	\begin{subfigure}{.5\textwidth}
%		\centering
%		\includegraphics[width=1\linewidth]{wrench_small.png}
%		\caption{Boxplot of \smallusers in te{}}
%		\label{fig:wrench_small}
%	\end{subfigure}%
%	\begin{subfigure}{.5\textwidth}
%		\centering
%		\includegraphics[width=1\linewidth]{wrenck_big.png}
%		\caption{Wrench on Z in \kt{}}
%		\label{fig:wrenck_big}
%	\end{subfigure}
%	\caption{Difference between wrench on Z in\\ \te{} and \kt{}}
%	\label{fig:boxplot_wrench}
%\end{figure}
