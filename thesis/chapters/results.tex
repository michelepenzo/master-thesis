...
%	\begin{subfigure}{.5\textwidth}
%		\centering
%		\includegraphics[width=1\linewidth]{waypoints_kt_t1.png}
%		\caption{Task 1}
%		\label{fig:waypoints_kt_t1}
%	\end{subfigure}%
%	\begin{subfigure}{.5\textwidth}
%		\centering
%		\includegraphics[width=1\linewidth]{waypoints_kt_t2.png}
%		\caption{Task 2}
%		\label{fig:waypoints_kt_t2}
%	\end{subfigure}
%	\caption{Waypoints precision in \kt{} teaching}
%	\label{fig:waypoints_kt}
%\end{figure}
%
%\begin{figure}[H]
%	\centering
%	\begin{subfigure}{.5\textwidth}
%		\centering
%		\includegraphics[width=1\linewidth]{waypoints_tt_t1.png}
%		\caption{Task 1}
%		\label{fig:waypoints_tt_t1}
%	\end{subfigure}%
%	\begin{subfigure}{.5\textwidth}
%		\centering
%		\includegraphics[width=1\linewidth]{waypoints_tt_t2.png}
%		\caption{Task 2}
%		\label{fig:waypoints_tt_t2}
%	\end{subfigure}
%	\caption{Waypoints precision in \te{} teaching}
%	\label{fig:waypoints_tt}
%\end{figure}
...
\begin{itemize}
	\item \textbf{Mental effort in \te{}}. This point is the one that needs the least explanation. In fact, the difference between the mental effort ($ 5,6 $ for \smallusers{} and $ 6 $ for \bigusers) of the groups are not high. We can say that the \smallusers{} group has a lower value, that implies that the users of this group are more relaxed. This is mainly due to the fact that these users have confidence with the pad, although this values should be higher because four users never seen a robot before this experiment. From these values it's possible to affirm that \te{} isn't mentally tiring.
	
	\item \textbf{Mental effort in \kt{}}. As shown in the relative table the differences between the two groups are substantial: $ 5,2 $ for \smallusers{} and $ 2,8 $ for \bigusers. Four users of \smallusers{} group started with \kt{} teaching so they had to be more mentally relaxed, but this didn't happen. This concept is related to the fact that more than half ot this group never use a robot before this experiment.
...
% resoconto differenze tra sforzi mentali delle due modalità


%From figure \ref{fig:plot_wrench} it's possible to notice the difference between the force applied on EE during the experiment. In \te{}, there is not interaction with the robot and the user control the robot without being in contact. This especially affects the effort of the users who are not used to using robots.


% risposte dei questionari
% quello che è scritto sopra ma commentato
