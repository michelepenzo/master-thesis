...
Three objects in \ref{fig:complete_task} of different shape and color were created using wood. The figures are medium in size, about $ 8x8$ $ cm $ and about $ 2 $ $ cm $ high (fig. \ref{fig:task_frontal}). Above them another little cube of $ 3x3x2 $ $ cm $ has been placed for proper grasping. With the gripper available it was not possible to use smaller objects. After that, some tests were conducted with this printed objects before submitting the final experiment to the sample of users. 

% TODO foto decente vista dall'alto dei 3 oggetti
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.06]{complete_task.jpg}
	\caption{Shapes for the final task}
	\label{fig:shapes}
\end{figure}

% TODO foto decente vista laterale di solamente uno
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.06,angle=-90]{cube_frontal.jpg}
