...
From the data collected by the test experiment described in the previous section, we decided to use some new objects for the final experiment.
At first, some Lego or boxes were used for the tests, but in the final experiment we decided to use some objects that could make the final scenario as similar as possible to reality.
