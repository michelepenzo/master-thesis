...
The same formula used for linear velocity for the \textit{full task space} mode was applied to move joints in the \textit{reduced joint space} mode. In figure \ref{pad} we can see the structure of the pad and how it was used to control the robot. In both cases, the buttons used are the same:
