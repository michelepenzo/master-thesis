...
The same formula for linear velocity was applied to move the joints. In both cases, the buttons used are the same. In figure \ref{pad} we can see the structure of the pad, while now the buttons used are presented
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.28]{ps4_pad.jpg}
