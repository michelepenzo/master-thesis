...
% todo Risulta inoltre essenziale aggiungere qualche equazione per spiegare il mapping tra il valore analogico letto dal pad (chiamalo \alpha) e il valore di velocità usato per moficare velocità lineare o angolare
