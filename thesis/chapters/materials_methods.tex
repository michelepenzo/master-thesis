...
This chapter describes the hardware and software setup: the components of the robot, how the robot can be programmed, the tools used to develop the project and which open source stack is used. Finally, the two proposed teaching modalities are explained.
...
\end{itemize}
When an action is performed by the user, the led strip (\circled{1} in figure \ref{fig:media_flange}) change color: green for waypoints, blue for gripper's actions.\\
