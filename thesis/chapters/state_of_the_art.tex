...
From \cite{robot-learning}, the authors compare the same interactions modalities used in our work but, in their case, the \te{} modality was implemented with an haptic device. This work highlights how \kt{} and the \te{} modality from them developed does not allow to take full advantage of the collaborative functionalities of the cobots. Moreover, their haptic device is not intuitive to use and does not have many buttons. To overcome these problems, our \te{} method was developed using a common joypad for video game.
From \cite{comparing-teleoperation} the scheme of the \te{} control that was developed was taken and perfected. This scheme was described in section \ref{teleoperation-pad}. Our user test, inspired from the work done in \cite{user-study-ks} consider similar assembly tasks, but their methodology used for the evaluation is only based on the force applied on a balance. In our user experiment, there were different evaluation metrics as described in chapter \ref{results-analysis}.
