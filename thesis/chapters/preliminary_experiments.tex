...
This chapter describes the preliminary hardware setup done before all the tests. Moreover, in section \ref{evaluation-force} and \ref{preliminary-experiments} the preliminary analysis on the robot are explained.
