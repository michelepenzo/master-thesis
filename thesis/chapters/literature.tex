...
The main goal of robot learning is to create a way for program robot in a simple way that are suitable to be used by everyday people. Two interactions methods are compared: \textit{\kt{}} and \textit{\te{}}. In the former, the user physically guides the robot and in the latter the user controls the robot with a pad.
