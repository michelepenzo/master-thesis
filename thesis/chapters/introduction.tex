...
% todo
% scrivere qualcosa di più interessante per la teleop --> perchè è stata introdotta??

\section{Goals}
\label{goals}

From \textit{PbD} paradigm described in the previous section, a new modality for teaching tasks and a comparison between \kt{} and \te{} was made to find the optimal method for teaching and reprogramming robots for industrial assembly tasks.
Before starting the work some questions and hypotheses can be done. Therefore we define some research questions to better center the goal of this thesis:
\begin{itemize}
