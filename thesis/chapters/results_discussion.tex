...
\noindent
From table \ref{tab:effort} is possible to see the differences in physical and mental effort according to the users of the various groups. These values help us to better understand the differences between the two modalities but also to focus on how much personal physical characteristics affect \te{} and \kt{} teaching. For a better explanation the various efforts in the two modalities are divided into four points:
\begin{itemize}
	% ===== DA QUI IN POI =====
