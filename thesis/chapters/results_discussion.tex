...
Starting from the data relative to the distance and time to complete the tasks in both the modalities, is possible to affirm that the phase relative to \te{} teaching is slower than the phase relative to \kt{} teaching. This aspect is independent from the division into groups .
