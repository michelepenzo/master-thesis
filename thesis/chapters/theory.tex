...
\label{theory}
This chapter consists in describing the basics notion about the robot, to understand better the entire work made on \kuka. Morover a description about the kinematic chains, the types of kinematic and about the most used notation is provided. Also an overview of different robot controls is provided.
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{kin_chain.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.15]{revolute_joint.png}
	\caption{A revolute joint, the same in \kuka{}}
	\label{fig:joint}
\end{figure}
...
From \cite{reference4}, there are two different types of kinematic that describe the behavior of the robot. In the next sections a little introduction about them is provided. Moreover a description on the commonly used notation for selecting references frame is provided in section~\ref{dh}.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.35]{forward_inverse_kinematic.jpg}
