...
Surely a test with a larger population, with more different physical and personal characteristics, could be done to show how the differences obtained from a larger sample of users can affect the two modalities. Moreover, the modality to train users in simulation could be implemented. 