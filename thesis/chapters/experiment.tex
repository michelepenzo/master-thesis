...
The experiment consists in three subtasks in ascending order of difficulty repeated for \rep{} times. We call the repetitions \textit{``trial''} and the subtasks are:
\begin{enumerate}
...
After the \textit{first} trial of every subtask the replay phase based on the waypoints and actions on gripper is shown to the users. In this way the user understands where he can improve.
