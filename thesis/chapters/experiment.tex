...
\label{participants}
The total number of participants is ten: seven male and three female. All of them are university graduates or students and between $ 24 $ and $ 27 $ years old and distributed as in figure \ref{fig:ages}.  Half of them never used a robot as our \kuka{}. In questionnaire data on physical characteristics as wight and height were collected to see if there are any correlations between these and the use of \kt{} teaching. In figures \ref{fig:height} and \ref{fig:weight} all the other intervals (of interval $ 10 $ $ kg/cm  $) were not included because no participant was included in them. 
To obtain better and diversified results among the participants, the modality from which one starts with the experiment is diversified. Half of the participants start with \te{}, the other with \kt{}. We recognize that we cannot assume that these participants describe a representative sample of the population but it's a good sample of data. 
