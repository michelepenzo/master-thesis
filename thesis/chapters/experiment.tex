...
% todo come allungare --> In questa sezione enfatizza che il task è stato progettato per mostrare due consizioni di assemblaggio realistiche, la seconda delle quali con la necessità di effettuare incastro ?
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.07]{cube_frontal.jpg}
