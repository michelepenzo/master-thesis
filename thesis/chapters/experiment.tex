...
\noindent In questionnaire data on physical characteristics as wight and height were collected to see if there are any correlations between the use of \kt{} and the physical characteristics of each user. In figures \ref{fig:height} and \ref{fig:weight} all the other intervals ($ 10cm $ for height and $ 10kg $ for weight) were not included because no participant was included in them. 
