...
\label{participants}
The total number of participants is $ 10 $. All of them are between $ 24 $ and $ 27 $ years old and distributed as in fig. \ref{fig:ages}. They are $ 7 $ male and $ 3 $ female and all participants are university graduates or students. Half of them never used a robot as our \kuka{}. In figures \ref{fig:height} and \ref{fig:weight} all the other intervals (of interval $ 10 $ $ kg/cm  $) were not included because no participant was included in them.
To obtain better and diversified results among the participants, the modality from which one starts is diversified. Half of the participants start with \te{}, the other with \kt{}. We recognize that we cannot assume that these participants describe a representative sample of the population. 
...
\begin{figure}[ht]
	...
	\caption{Answers to the question of how many times a console pad is used}
	\label{fig:pad}
\end{figure}

% TODO

% segnalare che non ci sono persone di pesi e altezze di quel tipo
