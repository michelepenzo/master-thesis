...
In this chapter is provided a complete and detailed description of the experiment, starting with the experimental design that was divided into three phases and described in every step. Later it's explained which data was collected. Finally a overview about the participants (who they are and their peculiarity) is provided. 
...
\begin{itemize}
	...
	\item if there is an error that does not depend by the user, the trail is repeated,
...
\noindent
To obtain better and diversified results among the participants, the modality in which each user starts with the experiment was diversified. Half of the participants started with \te{}, the other with \kt{}. To understand if users could be divided according to their abilities to use the pad, was asked them how often they use it: in figure \ref{fig:pad} are represented the answers.
...
\noindent We recognize that we can't assume that these participants describe a representative sample of the population but it's a good sample of data. 
