...
\begin{enumerate}
	...
	\item move the \nobj{} objects (fig. \ref{fig:objects}) into their interlocking position (fig. \ref{fig:interlocking}),
	\item perform a more complicated interlock: figure \ref{fig:complete_task} 
\end{enumerate}
