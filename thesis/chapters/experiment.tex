...
\begin{figure}[ht]
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[scale=0.03]{complete_task.jpg}
	...
	\end{subfigure}
	\caption{Place without interlocking}
	\label{fig:paper_interlocking}
\end{figure}
