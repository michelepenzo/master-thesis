...
\noindent
To obtain better and diversified results among the participants, the modality in which each user starts with the experiment is diversified. Half of the participants start with \te{}, the other with \kt{}. To understand if users could be divided according to their abilities to use the pad, were asked to them how often they use it: in figure \ref{fig:pad} the answers.
