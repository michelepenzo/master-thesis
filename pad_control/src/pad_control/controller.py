...
from teach_play.create_msgs import create_msg_control_mode, create_msg_cartesian_impedance, create_msg_position_control
...
if __name__ == '__main__':
	...
	#pub1 = rospy.Publisher('/iiwa/command/CartesianVelocity', TwistStamped, queue_size=1)
