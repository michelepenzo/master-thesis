...
\begin{frame}
	\frametitle{\secname}
	Before the experiment, were asked to the users to take confidence with both the modalities. Every user perform this phase without seeing other users do the same. \\~\
