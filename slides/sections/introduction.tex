...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \textbf{Goals}: this work proposes a new \te{} modality using a common pad for console for teaching assembly tasks. Therefore, with an user experiment, the work wants to highlight the differences between the two modalities.
	\end{itemize}
\end{frame}
...
\begin{frame}
	\frametitle{\secname}
	% img del pad con mapping dei comandi + foto del kuka
	% proponiamo .. setup con kuka IIwa, collaborativo, best robot, disponibile in ICE, grazie al robot
	% uso robot kuka iiwa e pad
	...
	It allows to have a safe remote control of the robot through the use of buttons and analogs. It also have a force feedback feature.
...
%	This video shows how \te{} teaching is used to perform the task.\\~\
	% 1x
	% normal speed --> per dire che il robot è a velocità normale
	\begin{center}
