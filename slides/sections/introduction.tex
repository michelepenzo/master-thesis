...
\begin{frame}
	...
	Instead assembly tasks that are mainly performed manually today are absolutely repetitive and they can be constantly changed.\\~\
...
\begin{frame}
	...
	It's a technique for teaching to the robot new behaviors by demonstrating the task through a sequence of commands.
\end{frame}
