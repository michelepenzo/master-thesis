...
\begin{frame}
	\frametitle{\secname}
	% spruzzaggio e saldatura
	% task di assemblaggio fatti a mano
	% quei pochi fatti con robot sono insegnati con kt
	...
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[width=50mm]{welding.jpg}
			&
			\includegraphics[width=50mm]{assembly.jpg}
			\\                                                     
			{\footnotesize Welding task}  & {\footnotesize Assembly task}
		\end{tabular}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[width=30mm]{kuka.jpg}
			&
			\includegraphics[width=60mm]{ps4_pad_lines.png}
			\\                                                     
			{\footnotesize \kuka{}}  & {\footnotesize PS4 pad}
		\end{tabular}
	\end{center}
