...
\begin{frame}
	...
	For reasons of time, only two of the research questions (the most important ones) are demonstrated through data. For a more complete and in-depth explanation, refer to the thesis.
\end{frame}
...
\begin{frame}
	\frametitle{\secname}
	This figure shows the difference of the forces applied by the groups while they were performing the tasks in \kt{} teaching. The force is in $ N $ and the time in $ seconds $.
	\begin{center}
...
\begin{frame}
	...
	Therefore, the mental efforts in \te{} teaching are: $ 5,6 $ for \smallusers{} and $ 6 $ for \bigusers{}.\\~\
