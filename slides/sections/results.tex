...
\begin{frame}
	...
	For reasons of time, in this presentation only two of the research questions are demonstrated through data. For a more complete and in-depth explanation, refer to the thesis.
\end{frame}
...
\begin{frame}
	\frametitle{\secname}
	\textbf{Are users who are familiar with joypad better at \te{} than the other users?}\\~\
...
\begin{frame}
	...
	The mental efforts in \te{} teaching are: $ 5,6 $ for \smallusers{} and $ 6 $ for \bigusers{}. Also, the data shows us how users confident with the pad are better in \te{}.\\~\
